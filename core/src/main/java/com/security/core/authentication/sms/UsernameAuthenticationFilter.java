...
public class UsernameAuthenticationFilter extends GenericFilterBean
	...
	public UsernameAuthenticationFilter(Set<RequestMatcher> matchers) {
		this.requiresAuthenticationRequestMatchers = matchers;
	}
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		UsernameRequestMatcher requestMatcher = (UsernameRequestMatcher) requiresAuthentication(request, response);
		if (requestMatcher == null || StringUtils.isEmpty(requestMatcher.getUsername())) {
		...
		try {
			authResult = attemptAuthentication(request, response, requestMatcher.getUsername());
			if (authResult == null) {
	...
	private RequestMatcher requiresAuthentication(HttpServletRequest request, HttpServletResponse response) {
	...
	public Authentication attemptAuthentication(HttpServletRequest request,
			HttpServletResponse response, String username) throws AuthenticationException, IOException,
			ServletException {
		if (!request.getMethod().equals("POST")) {
			throw new AuthenticationServiceException("Authentication method not supported: " + request.getMethod());
		}

		String usernameValue = obtainUsername(request, username);
	...
	protected String obtainUsername(HttpServletRequest request, String username) {
